...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	// static TCHAR lpOut1[100];	// wsprintf : 텍스트 저장용 변수		// -> CPlayer.h로 이동 필요	(정보창 표시)
	// static TCHAR lpOut2[100];	// wsprintf : 텍스트 저장용 변수
	// static TCHAR Combo1[100];	// wsprintf : 텍스트 저장용 변수		// -> CPlayer.h로 이동 필요	(콤보 표시)
	...
	case WM_CREATE:
	{
		...
		//SetTimer(hWnd, 2, 200, NULL);	// 애니메이션 타이머 (200ms 간격)
		break;
	}
